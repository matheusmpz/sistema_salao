<body class="bg-white flex items-center justify-center h-screen">
    ...
    <div class="bg-[#f9f9f9] rounded-xl p-10 w-full max-w-md shadow-lg space-y-8">
        <div class="space-y-2">
            <h1 class="text-3xl font-bold">Agendamento</h1>
            <p class="text-sm text-gray-500">
                Escolha o serviço desejado e a data para realizar seu agendamento.
            </p>
        </div>
        ...
        <form action="/sistema_salao/agendamento/agendar" method="POST" class="space-y-6">
            <div class="space-y-4">
                ...
                <div class="flex flex-col space-y-1">
                    <label for="data" class="text-sm font-medium">Data e Hora</label>
                    <input type="datetime-local" id="data" name="data" step="1800" required
                           class="py-3 px-4 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-black">
                </div>
            </div>
