<div class="min-h-screen flex items-center justify-center bg-gray-100 px-4">
  <form action="/servico/atualizar.php" method="POST" class="w-full max-w-md bg-white p-8 rounded-xl shadow-md">
    ...
    <div class="mb-4">
      ...
      <input type="text" name="nome" id="nome" required value="<?= $servico['nome'] ?>"
        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500" />
    </div>

    <div class="mb-4">
      <label for="preco" class="block text-sm font-medium text-gray-700 mb-1">Preço</label>
      <input type="number" step="0.01" name="preco" id="preco" required value="<?= $servico['preco'] ?>"
        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500" />
    </div>
    ...
    <div class="mb-6">
      ...
      <textarea name="descricao" id="descricao" rows="3" required
        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"><?= $servico['descricao'] ?></textarea>
    </div>
